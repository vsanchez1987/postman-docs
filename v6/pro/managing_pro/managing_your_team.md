...
An admin can modify the roles of other team members in the [Team page](https://go.postman.co/team){:target="_blank"}. 
...
In the [Team page](https://go.postman.co/team){:target="_blank"}, click the **Invite Users** button. 
